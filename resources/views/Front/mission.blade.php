...
<div class="inner-page-banner-area">
 ...
 <li><a href="index.html">Ana Sayfa</a> > </li>
    <li><a href="sayfa-misyonumuz-51.html">Kurumsal</a> > </li>
...
<img class="pull-left mr-15 thumbnail" src="/images/{{ $query->resim }}" style="max-width:300px;" alt="Misyonumuz">
<p>   <h4>Misyonumuz</h4>
...
<li><a href="{{ route('mission') }}"><i class="fa fa-chevron-right"
                                aria-hidden="true"></i><b>Misyonumuz</b></a></li>
