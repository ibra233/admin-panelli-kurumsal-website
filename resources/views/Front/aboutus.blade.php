    ...
    <div class="container">
        <div class="pagination-area">
            ...
            <ul>
                ...
                <li><a href="sayfa-hakkimizda-48.html">Kurumsal</a> ></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                <img class="pull-left mr-15 thumbnail" src="/images/{{ $query->resim }}" style="max-width:300px;"
                     alt="Hakkımızda">
                <p style="text-align: justify;">   <h4>Hakkımızda</h4>
                    ...
                    <div class="categories margin-bottom-sidebar">
                        ...
                        <ul>
                            <li><a href="{{ route('aboutus') }}"><i class="fa fa-chevron-right"
                                                                      aria-hidden="true"></i><b>Hakkımızda</b></a></li>
                            ...
                            <li><a href="{{ route('vision') }}"><i class="fa fa-chevron-right"
                                                                      aria-hidden="true"></i>Vizyonumuz</a></li>
                        </ul>
                    </div>
