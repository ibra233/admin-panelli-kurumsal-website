    ...
    <div class="alert alert-danger">
        ...
        @foreach ($query as  $firstValue => $item )
              ...
              <tr>
                ...
                <td class=" p-3">
                  <img style="width: 65px;" src="/images/{{$item->resim}}" class="img-fluid img-thumbnail fifth{{$item->kategori_id}}" alt="Sheep">
              </td>
...
document.querySelector('#deleteButon').setAttribute('href',`http://pastaneprojesi/admin/deleteCategory/${id}`);
 ...
 document.querySelector('#updateForm').setAttribute('action',`http://pastaneprojesi/admin/updateCategory/${iduni}`);
